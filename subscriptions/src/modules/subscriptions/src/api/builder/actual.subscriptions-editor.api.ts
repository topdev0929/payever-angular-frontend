...
import { PEB_SUBSCRIPTION_API_BUILDER_PATH, PEB_SUBSCRIPTION_API_PATH } from '../../constants';
import { SubscriptionEnvService } from '../subscription/subscription-env.service';

@Injectable()
export class ActualPebSubscriptionsEditorApi {
  constructor(
  ...
  getThemeDetail(themeId: PebShopThemeId, page?: string): Observable<PebThemeDetailInterface> {
    return this.http.get<PebThemeDetailInterface>(`${this.editorApiPath}/api/theme/${themeId}/detail`, {
  ...
  getPage(themeId: PebShopThemeId, pageId: PebPageId, screen?: string): Observable<PebThemePageInterface> {
    return this.http.get<PebThemePageInterface>(`${this.editorApiPath}/api/theme/${themeId}/page/${pageId}`, {
      params: screen ? { screen } : null,
    });
  }

  getPageStylesheet(themeId: PebShopThemeId, pageId: PebPageId, screen: string): Observable<any> {
  ...
  getPageActions(themeId: PebShopThemeId, pageId: PebPageId, limit = 20, offset = 0): Observable<PebAction[]> {
    return this.http.get<PebAction[]>(`${this.editorApiPath}/api/theme/${themeId}/page/${pageId}/actions`, {
  ...
  getShopActiveTheme(): Observable<any> {
    const { businessId, applicationId } = this.envService;
    const endpoint = `${this.editorApiPath}/api/business/${businessId}/application/${applicationId}/themes/active`;
  ...
  updateReplicas(themeId: string, actions: PebAction[]): Observable<PebThemeDetailInterface> {
    return this.http.put<PebThemeDetailInterface>(`${this.editorApiPath}/api/theme/${themeId}/actions/apply`, actions);
  }
  ...
  getShops(isDefault?: boolean): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop`, {
  ...
  getShop(): Observable<any> {
    ...
    return this.http.get<any[]>(
      `${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop/${this.envService.applicationId}`,
    );
  }
  ...
  updateShopDeploy(accessId: string, payload: any): Observable<any> {
    ...
    return this.http.patch<any[]>(
      `${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop/access/${accessId}`,
      payload,
    );
  }
  ...
  createShop(payload: any): Observable<any> {
    ...
    return this.http.post<any[]>(
      `${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop`,
      payload,
    );
  }
  ...
  deleteShop(shopId: string): Observable<null> {
    ...
    return this.http.delete<null>(
      `${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop/${shopId}`,
    );
  }
  ...
  setAsDefaultShop(shopId: string): Observable<any> {
    ...
    return this.http.put<any>(
      `${this.subscriptionApiPath}/api/business/${this.envService.businessId}/shop/${shopId}/default`,
      {},
    );
  }
  ...
  getShapesByAlbum(albumId: string, { offset = 0, limit = 100 }: PebPaginationParams = {}): Observable<any> {
    return this.http.get<any>(
      `${this.editorApiPath}/api/application/${this.envService.applicationId}/shape/album${
        albumId ? `/${albumId}` : ''
      }`,
  ...
  getShape(shapeId: string): Observable<any> {
    return this.http.get<any>(
      `${this.editorApiPath}/api/application/${this.envService.applicationId}/shape/${shapeId}`,
    );
  }

  patchShape(id: string, shape): Observable<any> {
    return this.http.patch<any>(
      `${this.editorApiPath}/api/application/${this.envService.applicationId}/shape/${id}`,
      shape,
    );
  }
  ...
  getTemplateShapesByAlbum(albumId: string, { offset = 0, limit = 100 }: PebPaginationParams = {}): Observable<any> {
    return this.http.get<any>(
      `${this.editorApiPath}/api/application/${this.envService.applicationId}/shape/template/album${
        albumId ? `/${albumId}` : ''
      }`,
      { params: { offset: offset.toString(), limit: limit.toString() } },
    );
