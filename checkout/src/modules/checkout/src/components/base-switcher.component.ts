import { Component, Directive, Injector, InjectionToken, Inject } from '@angular/core';
...
@Directive()
export abstract class BaseSwitcherComponent extends AbstractComponent {

  protected enableManageActions: boolean = true;
