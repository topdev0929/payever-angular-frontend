...
import { AppSetUpService, EnvironmentConfigInterface as EnvInterface } from '@pe/common';
...
export class WelcomeDetailsComponent extends AbstractComponent implements OnInit {
