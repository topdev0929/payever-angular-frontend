...
import { AbstractComponent, CreateCheckoutFormComponent } from '../../components';
...
export class CreateCheckoutComponent extends AbstractComponent implements OnInit {
  ...
  setModalOptions() {
    ...
    const config: PeOverlayConfig = {
      ...
      headerConfig: {
        ...
        doneBtnTitle: this.translateService.translate(this.createMode ? 'create_checkout.buttons.create' : 'actions.open'),
        doneBtnCallback: () => {
