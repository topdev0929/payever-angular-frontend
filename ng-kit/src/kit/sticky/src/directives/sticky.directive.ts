 ...
 *
 * Originally written by (c) 2016 Maksym Bidiuk
...
import { Directive, ElementRef, Input, Output, EventEmitter, HostListener, Renderer2, AfterViewInit } from '@angular/core';
