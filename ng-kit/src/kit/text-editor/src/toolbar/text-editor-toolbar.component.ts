import { Component, ElementRef, EventEmitter, Injector, Input, OnDestroy, OnInit, Output, Renderer2, ViewChild, AfterViewInit } from '@angular/core';
import { DomSanitizer } from '@angular/platform-browser';
import { ReplaySubject } from 'rxjs';
import { EditorToolbarForm, ExecuteCommandAction, LinksInterface, TextDecorationInterface, ToggleToolbarAction } from '../common/text-editor.interface';
import { DEFAULT_FONT_COLOR, DEFAULT_FONT_SIZE, ExecuteCommands, JustifyContent } from '../common/text-editor.constants';
import { TranslateService } from '../../../i18n/src/services/translate';
import { CheckboxLabelPosition, CheckboxSize } from '../../../form-components/checkbox/enums';
import { CheckboxChangeEvent } from '../../../form-components/checkbox/interfaces';
import { FormAbstractComponent } from '../../../form/components/form-abstract';
import { FormScheme, FormSchemeField } from '../../../form/interfaces';
import { ErrorBag } from '../../../form-core/services';
import { isValidURL, rgbToHex } from '../common/text-editor.utils';
import { InputSettingsInterface } from '../../../form-core/interfaces';
import { InputType } from '../../../form-core/enums';
import { FormFieldEnum } from '../../../form-core/types';
import { SelectChangeEvent, SelectSettingsInterface } from '../../../form-components/select/interfaces';
import { ColorPickerFormat } from '../../../form-components/color-picker/enums';
import { parseTestAttribute } from '../../../utils';
...
export class TextEditorToolbarComponent extends FormAbstractComponent<EditorToolbarForm> implements OnInit, OnDestroy, AfterViewInit {
  ...
  setCurrentLink(link: LinksInterface): void {
    ...
    this.actionClicked.emit({key: ExecuteCommands.INSERT_INTERNAL_LINK, options: {
      link,
