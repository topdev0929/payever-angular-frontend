...
const qrConnected: InfoBoxSettingsInterface = require('./qr.json');
const qrPreview: InfoBoxSettingsInterface = require('./qr.json');
const qrDownload: InfoBoxSettingsInterface = require('./qr.json');
const qrPrint: InfoBoxSettingsInterface = require('./qr.json');

export class ThirdPartyFormQrStubService implements ThirdPartyFormServiceInterface {
