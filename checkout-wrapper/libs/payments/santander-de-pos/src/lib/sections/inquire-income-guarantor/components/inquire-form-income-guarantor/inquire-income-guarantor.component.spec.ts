...
import { InquireIncomeGuarantorComponent } from './inquire-income-guarantor.component';

describe('InquireIncomeGuarantorComponent', () => {
  const storeHelper = new StoreHelper();

  let component: InquireIncomeGuarantorComponent;
  let fixture: ComponentFixture<InquireIncomeGuarantorComponent>;
  let store: Store;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(InquireIncomeGuarantorComponent);
  ...
  describe('Initialization', () => {
    ...
    it('should enable employmentForm control if the guarantor has a invalid profession', () => {
      const gProfession = 'invalid';
      jest.spyOn(store, 'selectSnapshot').mockReturnValueOnce({
        guarantor: {
          personalForm: { profession: gProfession },
        },
      });
    ...
    it('should disable employmentForm control if the guarantor has an valid profession', () => {
      const gProfession = NO_EMPLOYMENT_PROFESSIONS[0];
      jest.spyOn(store, 'selectSnapshot').mockReturnValueOnce({
        guarantor: {
          personalForm: { profession: gProfession },
        },
