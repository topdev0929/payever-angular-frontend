...
import { DocumentSideEnum } from '@pe/checkout/santander-de-pos/shared';
...
export class ImageCaptureComponent implements OnDestroy {
  ...
  @Input() documentType: DocumentSideEnum;
  ...
  public fileInputId = `pe-file-${String(Math.random()).substring(4)}`;
