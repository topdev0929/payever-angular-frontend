...
describe('FinishComponent', () => {
    ...
    describe('isNeedMoreInfo', () => {
        it('should return true for need more info status', () => {
            fixture.detectChanges();

            jest.spyOn(component, 'specificStatus', 'get')
                .mockReturnValue(PaymentSpecificStatusEnum.NEED_MORE_INFO_SIFO);
            expect(component.isNeedMoreInfo).toBe(true);

            jest.spyOn(component, 'specificStatus', 'get')
                .mockReturnValue(PaymentSpecificStatusEnum.NEED_MORE_INFO_DTI);
            expect(component.isNeedMoreInfo).toBe(true);

            jest.spyOn(component, 'specificStatus', 'get')
                .mockReturnValue(PaymentSpecificStatusEnum.NEED_MORE_INFO_IIR);
            expect(component.isNeedMoreInfo).toBe(true);
        });
        ...
        it('should return false for other statuses', () => {
            ...
            expect(component.isNeedMoreInfo).toBe(false);
        });
    });
    ...
    describe('isStatusSuccess', () => {
        ...
        it('should return false when isNeedMoreInfo returns true', () => {
            fixture.detectChanges();

            jest.spyOn(component, 'getPaymentStatus')
                .mockReturnValue(PaymentStatusEnum.STATUS_PAID);
            jest.spyOn(component, 'isNeedMoreInfo', 'get')
