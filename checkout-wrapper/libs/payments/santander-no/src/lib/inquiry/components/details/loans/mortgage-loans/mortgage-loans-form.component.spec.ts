...
import { MortgageLoansFormComponent } from './mortgage-loans-form.component';

describe('MortgageLoansFormComponent', () => {
  const storeHelper = new StoreHelper();
  let component: MortgageLoansFormComponent;
  let fixture: ComponentFixture<MortgageLoansFormComponent>;
  let store: Store;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MortgageLoansFormComponent);
