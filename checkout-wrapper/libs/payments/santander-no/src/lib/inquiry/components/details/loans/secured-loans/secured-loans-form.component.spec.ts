...
import { SecuredLoansFormComponent } from './secured-loans-form.component';

describe('SecuredLoansFormComponent', () => {
  const storeHelper = new StoreHelper();
  let component: SecuredLoansFormComponent;
  let fixture: ComponentFixture<SecuredLoansFormComponent>;
  let store: Store;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SecuredLoansFormComponent);
