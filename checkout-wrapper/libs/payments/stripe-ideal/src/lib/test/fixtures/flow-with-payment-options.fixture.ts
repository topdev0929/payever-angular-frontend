...
export const flowWithPaymentOptionsFixture: () => FlowInterface = () => cloneDeep<FlowInterface>({
  ...
  connectionId: 'stripe-ideal-connections-id',
  paymentOptions: [
    {
      name: 'stripe_ideal.name',
      paymentMethod: PaymentMethodEnum.STRIPE_IDEAL,
      max: 100000,
      min: 0,
      fixedFee: 0.25,
      acceptFee: false,
      ...
      connections: [
        {
          id: 'stripe-ideal-connections-id',
          default: false,
          name: 'stripe-ideal-connections-name',
