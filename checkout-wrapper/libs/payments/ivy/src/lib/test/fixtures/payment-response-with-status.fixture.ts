...
export const paymentResponseWithStatusFixture:
  (status: PaymentStatusEnum, specificStatus: PaymentSpecificStatusEnum) =>
    NodePaymentResponseInterface<NodePaymentDetailsResponseInterface> =
  (status: PaymentStatusEnum, specificStatus: PaymentSpecificStatusEnum) => cloneDeep({
    ...
    payment: {
      ...
      downPayment: 0,
      paymentType: PaymentMethodEnum.IVY,
    ...
    paymentDetails: {
      ...
      frontendCancelUrl: 'frontendCancelUrl',
      frontendFinishUrl: 'frontendFinishUrl',
      getPaymentStatusUrl: 'getPaymentStatusUrl',
    },
    paymentItems: [],
    options: {
