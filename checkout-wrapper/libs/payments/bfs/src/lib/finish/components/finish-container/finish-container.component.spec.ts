...
import { BfsApiService, BfsFlowService, PaymentService } from '../../../shared/service';
...
describe('FinishContainerComponent', () => {
  ...
  let store: Store;
  let bfsFlowService: BfsFlowService;
  ...
  beforeEach(() => {
    ...
    bfsFlowService = TestBed.inject(BfsFlowService);
  ...
  it('should show finish modal from existing payment', () => {
    ...
    const getPaymentSpy = jest.spyOn(bfsFlowService, 'getPayment')
      .mockReturnValue(of({
        payment: {},
      } as PaymentResponse));
  ...
  it('should handle error when getting payment', () => {
    ...
    const getPayment = jest.spyOn(bfsFlowService, 'getPayment')
