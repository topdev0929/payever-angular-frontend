...
describe('zinia-finish-v2', () => {
  ...
  describe('component', () => {
    ...
    it('closeOtp', () => {
      const close = jest.spyOn(FinishDialogService.prototype, 'close');
      const dispatch = jest.spyOn(store, 'dispatch');
      const setPaymentLoading = jest.spyOn(PaymentHelperService.prototype, 'setPaymentLoading');
      component.closeOtp();
