...
import { ABSTRACT_PAYMENT_SERVICE, AbstractPaymentContainerComponent } from '@pe/checkout/payment';
...
describe('BaseContainerComponent', () => {
  ...
  describe('Constructor', () => {
    it('Should create an instance', () => {
      ...
      expect(component instanceof AbstractPaymentContainerComponent).toBeTruthy();
    });
  });
});
