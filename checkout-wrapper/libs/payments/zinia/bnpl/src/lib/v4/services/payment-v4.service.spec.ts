...
import { ZiniaPaymentService } from './payment-v4.service';
...
describe('PaymentService', () => {
  ...
  describe('service', () => {
    ...
    it('postPayment', (done) => {
      ...
      const ziniaBnplUtilsService = TestBed.inject(ZiniaBnplUtilsService);
      ...
      instance.postPayment().subscribe((response) => {
        ...
        const nodePaymentDetails: Partial<PaymentDetails> = {
          ...
          deviceInfo: ziniaBnplUtilsService.getDeviceInfo(),
          browserInfo: ziniaBnplUtilsService.getBrowserInfo(),
        };
