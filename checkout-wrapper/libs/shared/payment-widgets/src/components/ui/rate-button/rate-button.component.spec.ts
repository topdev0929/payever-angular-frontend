...
import { UIRateButtonComponent } from './rate-button.component';

@Component({
  selector: 'finexp-ui-rate-button-test-component',
  template: `
    <finexp-ui-rate-button>text content</finexp-ui-rate-button>
  `,
})
class TestComponent { }

describe('finexp-ui-rate-button', () => {
  let testComponent: TestComponent;
  let componentEl: DebugElement;
  let fixture: ComponentFixture<TestComponent>;
  let component: InstanceType<typeof UIRateButtonComponent>;
  ...
  beforeEach(() => {
    ...
    componentEl = fixture.debugElement.query(By.directive(UIRateButtonComponent));
  ...
  describe('component', () => {
    it('Should set the text color', () => {
      ...
      const rateText = fixture.debugElement.query(By.css('.rate-button'));
    ...
    it('should emit clicked', () => {
      ...
      componentEl.nativeElement.click();
