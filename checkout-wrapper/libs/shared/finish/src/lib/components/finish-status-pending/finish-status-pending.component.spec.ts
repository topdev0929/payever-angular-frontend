...
import { FinishStatusPendingComponent } from './finish-status-pending.component';

describe('checkout-sdk-finish-status-pending', () => {
  let component: FinishStatusPendingComponent;
  let fixture: ComponentFixture<FinishStatusPendingComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [FinishStatusPendingComponent, StatusIconComponent],
      schemas: [],
    }).compileComponents();

    fixture = TestBed.createComponent(FinishStatusPendingComponent);
  ...
  it('should render icon', () => {
    initComponent();
    expect(fixture.debugElement.query(By.directive(StatusIconComponent)).componentInstance.status).toEqual('pending');
  });
  ...
  it('should render signingCenterLink', () => {
    ...
    expect(link.textContent).toContain('checkout_sdk.finish_status_pending.print_docs');
  });
  ...
  it('should render contractUrl', () => {
    ...
    expect(link.target).toEqual('_blank');
    expect(link.textContent).toContain('checkout_sdk.finish_status_pending.download_contract');
  });
});
