...
@Component({
  ...
  selector: 'widget-santander-de-custom-element',
  template: '',
})
  ...
  describe('component', () => {
    it('getCreditFormatted', () => {
      expect(component.getCreditFormatted(rates.rates[0])).toMatchObject({
        ...
        annualPercentageRate: 1,
        bank_interest_with_currency: '$1',
        duration: 1,
        duration_with_months: '1',
        interest: 1,
        interestRate: 2,
        interest_rate_with_persent: '1%',
        lastMonthPayment: 8338.54,
        monthlyPayment: 8343.54,
        monthly_rate_with_currency: '$8,343.54',
        price_with_currency: '$50,049.50',
        rate_pa_with_persent: '2%',
        specificData: {
          firstInstallment: 8342.8,
          processingFee: 25,
          rsvTotal: 3,
