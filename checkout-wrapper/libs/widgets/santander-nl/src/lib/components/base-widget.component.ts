...
export abstract class BaseWidgetComponent extends BaseBaseWidgetComponent<CreditInterface> implements OnChanges {
  ...
  readonly payment = PaymentMethodEnum.SANTANDER_INSTALLMENT_NL;
  ...
  public get translations() {
    return {
      showWrapperTitle: $localize `:@@santander-nl-finexp-widget.common.show_checkout_wrapper:`,
      moreInfoTitle: $localize `:@@santander-nl-finexp-widget.common.show_more_info:`,
      headerText: $localize `:@@santander-nl-finexp-widget.common.header_text:`,
      headerExtendedText: $localize `:@@santander-nl-finexp-widget.common.header_text_extended:`,
      introductionText: $localize `:@@santander-nl-finexp-widget.common.introduction_text:`,
      creditDetailsText: $localize `:@@santander-nl-finexp-widget.common.credit_details_text:`,
    };
  }
  ...
  toMonths(count: number): string {
    return count === 1
      ? $localize `:@@santander-nl-finexp-widget.common.month.one:${count}:count:`
      : $localize `:@@santander-nl-finexp-widget.common.month.many:${count}:count:`;
  }
  ...
  protected transformRate(credit: CreditInterface): RateInterface {
    ...
    return {
      ...
      selectedMultiTitles: [
        ...
        {
          label: translations.rateParams.monthlyPayment,
          text: monthlyRate,
        },
      ],
      details: [
        ...
        {
          title: translations.rateParams.duration,
          value: this.toMonths(credit.duration),
        },
        {
          title: translations.rateParams.annualPercentageCost,
        ...
        {
          title: translations.rateParams.totalCreditCost,
  ...
  private translateRate(credit: CreditInterface) {
    ...
    return {
      rateTitle: $localize `:@@santander-nl-finexp-widget.common.rate_title:\
      ${monthly_rate_with_currency}:monthly_rate_with_currency:\
      ${duration_with_months}:duration_with_months:`,
      rateParams: {
        monthlyPayment: $localize `:@@santander-nl-finexp-widget.common.rate_param.monthly_payment:`,
        annualPercentageCost: $localize `:@@santander-nl-finexp-widget.common.rate_param.annual_percentage_cost:`,
        amount: $localize `:@@santander-nl-finexp-widget.common.rate_param.amount:`,
        duration: $localize `:@@santander-nl-finexp-widget.common.rate_param.duration:`,
        annualPercentageRate: $localize `:@@santander-nl-finexp-widget.common.rate_param.annual_percentage_rate:`,
        totalCreditCost: $localize `:@@santander-nl-finexp-widget.common.rate_param.total_credit_cost:`,
      },
    };
  }
}
