...
describe('two-fields-calculator component', () => {
  ...
  describe('component', () => {
    ...
    it('should render finexp-ui-regular-text', () => {
      ExpectNotToRenderChild(fixture, UIRegularTextComponent);

      initComponent(CheckoutModeEnum.None);
    ...
    it('rate-dropdown isLoading', (done) => {
