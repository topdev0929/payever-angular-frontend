...
import { ZiniaInstallmentsWidgetModule } from '../../zinia-installments-widget.module';
...
import { ZiniaInstallmentsCustomElementComponent } from './custom-element.component';

describe('widget-zinia-installments-custom-element', () => {
  let store: Store;

  let component: ZiniaInstallmentsCustomElementComponent;
  let fixture: ComponentFixture<ZiniaInstallmentsCustomElementComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        importProvidersFrom(ZiniaInstallmentsWidgetModule),
        ...CommonProvidersTestHelper(),
    ...
    fixture = TestBed.createComponent(ZiniaInstallmentsCustomElementComponent);
  ...
  const initComponent = () => {
    fixture.componentRef.setInput('config', {
      ...
      payments: [
        {
          paymentMethod: PaymentMethodEnum.ZINIA_INSTALLMENT_DE,
        },
      ],
  ...
  describe('Constructor', () => {
    ...
    describe('component', () => {
      it('widget-zinia-installments-button I/O', () => {
      ...
      it('widget-zinia-installments-dropdown-calculator I/O', () => {
      ...
      it('widget-zinia-installments-text I/O', () => {
      ...
      it('widget-zinia-installments-two-fields-calculator I/O', () => {
