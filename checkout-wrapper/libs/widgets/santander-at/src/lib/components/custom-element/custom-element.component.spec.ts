...
import { SantanderAtCustomElementComponent } from './custom-element.component';

describe('widget-santander-at-custom-element', () => {
  let store: Store;

  let component: SantanderAtCustomElementComponent;
  let fixture: ComponentFixture<SantanderAtCustomElementComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SantanderAtCustomElementComponent);
  ...
  describe('Constructor', () => {
    ...
    describe('component', () => {
      it('widget-santander-at-button I/O', () => {
      ...
      it('widget-santander-at-dropdown-calculator I/O', () => {
      ...
      it('widget-santander-at-text I/O', () => {
      ...
      it('widget-santander-at-two-fields-calculator I/O', () => {
