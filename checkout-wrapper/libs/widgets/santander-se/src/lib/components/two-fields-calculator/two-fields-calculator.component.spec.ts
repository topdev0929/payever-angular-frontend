    ...
    describe('headerText translations', () => {
      it('BNPL', () => {
        ...
        expect(component.translations.headerText)
          .toEqual($localize`:@@santander-se-finexp-widget.bnpl.calculator.header_text:`);
        expect(component.translations.headerExtendedText)
          .toEqual($localize`:@@santander-se-finexp-widget.bnpl.calculator.header_text_extended:`);
      });
      ...
      it('regular', () => {
        ...
        expect(component.translations.headerText)
          .toEqual($localize`:@@santander-se-finexp-widget.regular.calculator.header_text:`);
        expect(component.translations.headerExtendedText)
          .toEqual($localize`:@@santander-se-finexp-widget.regular.calculator.header_text_extended:`);
      });
    });
