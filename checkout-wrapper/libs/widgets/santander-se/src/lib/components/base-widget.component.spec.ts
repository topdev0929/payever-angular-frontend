  ...
  describe('component', () => {
    it('getCreditFormatted', () => {
      ...
      expect(component.getCreditFormatted(rates.rates[0])).toMatchObject({
        ...
        startupFee: 195,
        totalCost: 50465,
        months_with_months: '6',
        monthly_cost_with_currency: '$8,378',
        effective_interest_with_persent: '1.34%',
        total_cost_with_currency: '$50,465',
        startup_fee_with_currency: '$195',
        annual_fee_with_currency: '$0',
        billing_fee_with_currency: '$0',
      });
    });
