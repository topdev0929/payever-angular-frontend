...
import { SantanderNoCustomElementComponent } from './custom-element.component';

describe('widget-santander-no-custom-element', () => {
  let store: Store;

  let component: SantanderNoCustomElementComponent;
  let fixture: ComponentFixture<SantanderNoCustomElementComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SantanderNoCustomElementComponent);
  ...
  describe('Constructor', () => {
    ...
    describe('component', () => {
      it('widget-santander-no-button I/O', () => {
      ...
      it('widget-santander-no-dropdown-calculator I/O', () => {
      ...
      it('widget-santander-no-text I/O', () => {
      ...
      it('widget-santander-no-two-fields-calculator I/O', () => {
