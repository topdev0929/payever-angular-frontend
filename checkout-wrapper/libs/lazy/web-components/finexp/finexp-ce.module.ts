...
import { CheckoutWrapperByChannelSetIdFinExpComponent } from './checkout-wrapper-by-channel-set-id-finexp.component';

@NgModule({
  declarations: [
    CheckoutWrapperByChannelSetIdFinExpComponent,
  ],
  imports: [
    CommonModule,
    PluginsModule,
...
export class CeFinexpModule extends BaseWebComponentModule {
  resolveComponent(): Type<CheckoutWrapperByChannelSetIdFinExpComponent> {
    return CheckoutWrapperByChannelSetIdFinExpComponent;
  }
}
