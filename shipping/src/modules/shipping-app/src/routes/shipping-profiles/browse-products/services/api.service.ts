...
import { FormattedFilter, Filter } from '../../../../interfaces/products/filter.interface';
import { CollectionModel } from '../../../../interfaces/products/collection-model';
import { ProductModel, Product, ProductInventoryInterface } from '../../../../interfaces/products/product.interface';
...
import { CollectionsLoadedInterface, Collection } from '../../../../interfaces/products/collection.interface';
...
export class ProductsApiService {
  ...
  constructor(private apollo: Apollo, private http: HttpClient, @Inject(PE_ENV) private env: EnvironmentConfigInterface) {}
  ...
  getApplicationConfig(businessId: string): Observable<any> {
    return of(this.env).pipe(
      switchMap((config: any) => {
        ...
        const apiURL: string = `${config.backend.commerceos}/api/apps/business/${businessId}`;
