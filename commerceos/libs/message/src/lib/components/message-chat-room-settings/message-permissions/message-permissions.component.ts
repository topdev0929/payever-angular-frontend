...
import { PeMessageMember, PeMessageChatRoomListService, PeMessageApiService } from '@pe/message/shared';
...
export class PeMessagePermissionsComponent implements OnInit {
  ...
  public showDismissMemberConfirmationDialog(channel, member) {
    const headings: Headings = {
      title:  this.translateService.translate('message-app.channel.settings.remove-member-overlay.title')
