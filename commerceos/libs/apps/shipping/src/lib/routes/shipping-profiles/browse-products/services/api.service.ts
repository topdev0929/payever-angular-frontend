...
export class ProductsApiService {
  ...
  getCategories(businessUuid: string, titleChunk: string, page: number, perPage: number): Observable<ApolloQueryResult<Category>> {
    return this.apollo.use('products').query({
  ...
  createCategory(businessUuid: string, title: string): Observable<FetchResult<Category>> {
    return this.apollo.use('products').mutate({
