...
import { FolderItem, PeFoldersActionsEnum } from '@pe/shared/folders';
...
export class GroupModalComponent implements OnInit {
  ...
  public folderNamePlaceholder = this.translateService.translate('contacts-app.group_modal.new_group_name_placeholder');
