  ...
  private readonly controlsValidationHandler$ = this.initControlsValidation$
    .pipe(
      ...
      tap(() => {
        ...
        if (typeControls.type.value === PeCouponTypeEnum.FreeShipping) {
          typeControls.freeShippingType.value === PeCouponTypeFreeShippingTypeEnum.SelectedCountries
            ? typeControls.freeShippingToCountries.enable()
            : typeControls.freeShippingToCountries.disable();

          typeControls.excludeShippingRatesOverCertainAmount.value
        ...
        if (typeControls.type.value === PeCouponTypeEnum.BuyXGetY) {
          ...
          if (typeControls.buyType.value === PeCouponTypeBuyXGetYItemTypeEnum.SpecificCategories) {
            typeControls.buyProducts.disable();
            typeControls.buyCategories.enable();
          }

          if (typeControls.buyType.value === PeCouponTypeBuyXGetYItemTypeEnum.SpecificProducts) {
            typeControls.buyCategories.disable();
            typeControls.buyProducts.enable();
          }

          if (typeControls.getType.value === PeCouponTypeBuyXGetYItemTypeEnum.SpecificCategories) {
            typeControls.getProducts.disable();
            typeControls.getCategories.enable();
          }

          if (typeControls.getType.value === PeCouponTypeBuyXGetYItemTypeEnum.SpecificProducts) {
            typeControls.getCategories.disable();
            typeControls.getProducts.enable();
          }

          typeControls.getDiscountType.value === PeCouponTypeBuyXGetYGetDiscountTypesEnum.Percentage
            ? typeControls.getDiscountValue.enable()
            : typeControls.getDiscountValue.disable();

          typeControls.maxUsesPerOrder.value
