  ...
  getDataGridItems(wallpapers: WallpaperDataInterface[],
    ...
    return wallpapers.map((wallpaper) => {
      ...
      const item =  {
        ...
        image: wallpaperType === WalpaperType.PreLoad ? wallpaper.wallpaper : this.mediaUrlPipe.transform(wallpaper.wallpaper, this.mediaContainerType),
        ...
        initialLoading: wallpaper.isLoading,
      };
