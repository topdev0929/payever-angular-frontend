...
export class BusinessEnvService extends EnvService {
  ...
  protected businessAccessOptionsSubject = new BehaviorSubject<BusinessAccessOptionsInterface>(null);
  public businessAccessOptions$ = this.businessAccessOptionsSubject.asObservable();

  set businessAccessOptions(value: BusinessAccessOptionsInterface) {
    this.businessAccessOptionsSubject.next(value);
  }

  get businessAccessOptions(): BusinessAccessOptionsInterface {
    return this.businessAccessOptionsSubject.value;
  }
}
