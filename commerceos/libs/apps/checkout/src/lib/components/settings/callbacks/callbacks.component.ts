...
export class CallbacksComponent implements OnInit {
  ...
  callbacksForm = this.fb.group({
    successUrl: [null, [Validators.pattern(this.urlPattern)]],
    pendingUrl: [null, [Validators.pattern(this.urlPattern)]],
    cancelUrl: [null, [Validators.pattern(this.urlPattern)]],
    failureUrl: [null, [Validators.pattern(this.urlPattern)]],
    noticeUrl: [null, [Validators.pattern(this.urlPattern)]],
  });
