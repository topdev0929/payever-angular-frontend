...
export class ApiService implements FinexpApiAbstractService {
  ...
  patchInstalledCheckoutConnectionsSortOrder(businessId: string, checkoutId: string, data: any): Observable<any> {
    return this.http.patch<any>(
      `${this.env.backend.checkout}/api/business/${businessId}/checkout/${checkoutId}/connection/sort-order`,
      data
    );
  }
  ...
  ): Observable<WidgetConfigInterface> {
    return this.http.post<CustomWidgetConfigInterface>(
