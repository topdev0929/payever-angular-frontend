...
export class ChannelSettingsBoxComponent implements AfterViewInit, OnInit {

  @Input() allowSettingsManualScroll = true;
  ...
  onPan(data: { deltaX: number, distance: number; }) {
    ...
    this.swipeValue = this.startSwipeValue + data.deltaX;
