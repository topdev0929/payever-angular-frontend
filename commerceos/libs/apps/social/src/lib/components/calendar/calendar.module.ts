...
import { PeSocialCalendarStylesComponent } from "./calendar-styles.component";
...
@NgModule({
  declarations: [
    ...
    PeSocialCalendarStylesComponent,
  ...
  providers: [
    ...
    PeSocialGridService,
    TitleCasePipe,
    // for dependency injection error on overlay widget repo
    {
