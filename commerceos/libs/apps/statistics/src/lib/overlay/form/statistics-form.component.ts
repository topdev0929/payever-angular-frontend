...
import { PE_OVERLAY_CONFIG, PeOverlayWidgetService } from '@pe/overlay-widget';
...
import { sizeOptions } from '../constants/size-options.constant';
...
export class PeStatisticsFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.addWidgetForm.valueChanges.pipe(tap(this.formPreviewDataSource), takeUntil(this.destroy$)).subscribe();
