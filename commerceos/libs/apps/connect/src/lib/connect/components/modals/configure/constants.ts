...
export const modalComponents = {
  ...
  shopsystems: {
    ...
    opencart: DefaultPluginMainComponent,
    oro_commerce: DefaultPluginMainComponent,
    shopware_cloud: DefaultPluginMainComponent,
    magento_hyva: DefaultPluginMainComponent,
