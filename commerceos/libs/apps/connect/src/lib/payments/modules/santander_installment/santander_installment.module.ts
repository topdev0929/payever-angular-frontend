...
import {
  SantanderInstallmentAuthenticationComponent,
  SantanderInstallmentAccountComponent,
  SantanderInstallmentsMainComponent,
} from './components';

export const SantanderInstallmentI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    SantanderInstallmentI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class SantanderInstallmentModule {}
