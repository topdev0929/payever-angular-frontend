...
import {
  SofortAuthenticationComponent,
  SofortExternalRegisterComponent,
  SofortMainComponent,
} from './components';

export const SofortI18nModuleForChild = I18nModule.forChild();
