...
import {
  SantanderPosFactoringDeAuthenticationComponent,
  SantanderPosFactoringDeMainComponent,
} from './components';

export const SantanderPosFactoringDeI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    SantanderPosFactoringDeI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class SantanderPosFactoringDeModule {}
