...
import {
  SantanderPosInvoiceDeAuthenticationComponent,
  SantanderPosInvoiceDeMainComponent,
} from './components';

export const SantanderPosInvoiceDeI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    SantanderPosInvoiceDeI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class SantanderPosInvoiceDeModule {}
