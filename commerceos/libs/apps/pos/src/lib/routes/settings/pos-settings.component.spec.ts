...
describe('PebShopSettingsComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    apiSpy.getList.and.returnValue(EMPTY);
  ...
  it('should get pos list', () => {
    ...
    api.getList.and.returnValue(of(terminals));
    api.getPos.and.returnValue(of(terminal));
    ...
    expect(api.getPos).toHaveBeenCalledWith(envService.posId);
  ...
  it('should open overlay', () => {
    ...
    expect(config.data).toEqual({
      ...terminal,
      onSaved$: component.onSavedSubject$,
    });
