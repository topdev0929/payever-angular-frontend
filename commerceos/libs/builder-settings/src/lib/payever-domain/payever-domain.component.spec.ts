...
describe('PeSettingsPayeverDomainComponent', () => {
  ...
  let api: jasmine.SpyObj<PebAppsApi>;
  let appData: any;
  let config: any;
  ...
  beforeEach(waitForAsync(() => {
    ...
    const apiSpy = jasmine.createSpyObj<PebAppsApi>('PebAppsApi', [
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: PebAppsApi, useValue: apiSpy },
      ...
      api = TestBed.inject(PebAppsApi) as jasmine.SpyObj<PebAppsApi>;
