...
import { DEFAULT_FONT_COLOR, DEFAULT_FONT_SIZE, ExecuteCommands, JustifyContent, PLACEHOLDER_ITEM_DATA_TOKEN } from '../text-editor.constants';
import {
  EditorToolbarForm,
...
export class TextEditorToolbarComponent extends FormAbstractComponent<EditorToolbarForm> implements OnInit, OnDestroy, AfterViewInit {
  ...
  @Input() placeholderData: TextEditorPlaceholderItem[];
  ...
  public openPlaceholderMenu(): void {
    ...
    const portalInjector = Injector.create({
      providers: [
        {
          provide: PLACEHOLDER_ITEM_DATA_TOKEN,
          useValue: this.placeholderData,
        },
      ],
    });
    const componentPortal = new ComponentPortal(PeTextEditorPlaceholderComponent, null, portalInjector);
