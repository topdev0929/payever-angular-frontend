...
import { PeFoldersContextMenuEnum, FolderItem, FolderPosition } from '@pe/shared/folders';
...
export class FolderTree {
  ...
  constructor(
    ...
    merge(
      ...
      (this.dataSource as any)._flattenedData.pipe(
        tap((folders) => {
          this.calculatePositions(folders as FolderItemFlatNode[]);
        }),
      ),
    ).pipe()
      .subscribe();
