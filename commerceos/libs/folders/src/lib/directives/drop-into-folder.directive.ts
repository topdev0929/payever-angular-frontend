...
import { PreviewType } from '@pe/shared/folders';

import { PreviewContainerComponent } from '../components/preview-container/preview.component';
import { MoveIntoFolderEvent, MoveIntoRootFolderEvent, PeMoveToFolderItem } from '../interfaces/folder.interface';
...
export class DropIntoFolderDirective implements OnInit {
  ...
  private prepareNodeCopyAsDragImage(
    ...
    if (srcNode.nodeType === 1) {
      ...
      for (const csName of Array.from(cssStyles)) {
