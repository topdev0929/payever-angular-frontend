...
export class WidgetsLayoutComponent implements OnInit, OnDestroy {
        ...
        return widgets
          .map((widget: any) => {
            ...
            return {
              ...
              installedApp: false,
              defaultApp: micro?.default || false,
  ...
  onOpenButtonClick(appName: WidgetTypeEnum, appUrlPath?: string): Observable<any> {
    ...
    return this.employeesPermissionService.checkApps(micro.code).pipe(
  ...
  private initTransactionsWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360002505639-payever-Transactions",
  ...
  private initStoreWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360001870554-payever-Shop",
      showInstallAppButton: true,
  ...
  private initMessageWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      data: [],
      helpUrl:"https://support.payever.org/hc/en-us/categories/4402737219730-payever-Message",
  ...
  private initShippingWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360002490060-payever-Shipping",
      data: [],
  ...
  private initPosWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360001887713-payever-Point-of-Sale",
  ...
  private initCheckoutWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360001870654-payever-Checkout",
      data: [],
      showInstallAppButton: true,
  ...
  private initConnectWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      helpUrl: "https://support.payever.org/hc/en-us/categories/360002505599-payever-Connect",
      data: [],
      showInstallAppButton: true,
      openButtonFn: () => {
  ...
  private initProductsWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      data: [],
      showInstallAppButton: true,
      helpUrl: "https://support.payever.org/hc/en-us/categories/360001870634-payever-Products",
      openButtonFn: () => {
  ...
  private initSettingsWidget(widget: WidgetInfoInterface): Widget {
    return {
      ...
      data: [],
      helpUrl: "https://support.payever.org/hc/en-us/categories/360002490100-payever-Settings",
      showInstallAppButton: true,
      openButtonFn: () => {
