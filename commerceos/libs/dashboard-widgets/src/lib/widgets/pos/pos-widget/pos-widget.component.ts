...
export class PosWidgetComponent extends AbstractWidgetComponent implements OnInit {
  ...
  onOpenButtonClick(): void {
    ...
    if (this.terminal$?.value?.terminalId && this.businessData?._id) {
    ...
    if (micro && micro.setupStatus === AppSetUpStatusEnum.Completed && this.appUrlPath) {
      ...
      const url = `business/${this.businessData._id}/pos`;
