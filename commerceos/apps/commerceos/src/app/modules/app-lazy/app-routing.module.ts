...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('@pe/entry/second-factor-code').then(m => m.SecondFactorCodeModule),
      },
      {
        ...
        loadChildren: () => import('@pe/entry/security-question').then(m => m.SecurityQuestionModule),
      },
      {
        path: 'switcher',
