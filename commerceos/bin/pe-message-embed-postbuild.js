...
(async function build() {
  ...
  //version 12.0.4
        ...
        link.setAttribute('src', 'https://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js');
        ...
        window.toggleButton = function() {
          const bubbleButton = document.querySelector('pe-message-bubble-item');
          if (bubbleButton) {
            bubbleButton.click()
          }
        };

        window.insertMessageComponent = function() {
        ...
        window.removeMessageComponent = function() {
          var msg = document.querySelector('pe-message-webcomponent');
          msg?.remove();
        };
