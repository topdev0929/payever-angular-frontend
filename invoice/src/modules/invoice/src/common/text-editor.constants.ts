...
export const DEFAULT_FONT_SIZE: number = 24;
export const DEFAULT_FONT_WEIGHT: string = 'normal';
export const DEFAULT_FONT_COLOR: string = '#000000';
export const DEFAULT_ALIGN: string = 'left';

export const EMPTY_CHAR: string = '&#8203';
export const ESCAPE_CHAR: string = '%u200B';
export const EMPTY_TEXT: string = '<span>&#8203</span>';
export const EMPTY_TEXT_WIDTH_STYLES: string = `<div style="text-align: ${DEFAULT_ALIGN}; font-size: ${DEFAULT_FONT_SIZE}; color: ${DEFAULT_FONT_COLOR}"></div>`;
