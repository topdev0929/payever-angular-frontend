...
import { EventEmitter, Injector, Output, QueryList, ViewChildren, OnInit, OnDestroy, Input, Component, Inject } from '@angular/core';
...
*/
  ...
  get formStorageKey(): string {
    return 'payment-onboarding-form-' + this.paymentMethod; // TODO Make more unique for business
  }
