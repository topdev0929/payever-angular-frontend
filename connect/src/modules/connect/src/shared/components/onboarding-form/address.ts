...
export class AddressHelperService {
  ...
  createForm(initialData: AddressFormFieldsInterface, requiredFields: string[]): { form: FormGroup, formSchemeFields: FormSchemeField[] } {
    ...
    const form: FormGroup = this.formBuilder.group({
      googleAutocomplete: [companyAddress.googleAutocomplete || fullAddressDefault || '', requiredFields.indexOf('companyAddress.googleAutocomplete') >= 0 ? req : []],
