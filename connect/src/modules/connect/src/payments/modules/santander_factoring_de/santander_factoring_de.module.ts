...
import {
  SantanderFactoringDeAuthenticationComponent,
  SantanderFactoringDeMainComponent,
} from './components';

export const SantanderFactoringDeI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    SantanderFactoringDeI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class SantanderFactoringDeModule {}
