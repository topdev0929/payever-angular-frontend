...
export class SantanderInstallmentSeAuthenticationComponent extends BaseAuthStoreIdMerchantNumberStoreIdentifier {

  readonly paymentMethod: PaymentMethodEnum = PaymentMethodEnum.SANTANDER_INSTALLMENT_SE;
