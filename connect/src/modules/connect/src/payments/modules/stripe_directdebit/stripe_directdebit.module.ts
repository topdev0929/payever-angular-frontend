...
import {
  StripeDirectDebitMainComponent,
} from './components';

export const StripeDirectDebitI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    StripeDirectDebitI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class StripeDirectDebitModule {}
