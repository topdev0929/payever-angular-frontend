...
import {
  PaymillDirectdebitAuthenticationComponent,
  PaymillDirectdebitMainComponent,
} from './components';

export const PaymillDirectdebitI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    PaymillDirectdebitI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class PaymillDirectdebitModule {}
