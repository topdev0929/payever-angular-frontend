import { Injector, OnInit, OnDestroy, Input, Directive } from '@angular/core';
...
@Directive()
export abstract class BasePaymentFormComponent<T> extends FormAbstractComponent<T> implements OnInit, OnDestroy {
