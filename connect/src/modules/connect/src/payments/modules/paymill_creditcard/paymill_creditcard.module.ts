...
import {
  PaymillCreditcardAuthenticationComponent,
  PaymillCreditcardMainComponent,
} from './components';

export const PaymillCreditcardI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    ButtonModule,
    PaymillCreditcardI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class PaymillCreditcardModule {}
