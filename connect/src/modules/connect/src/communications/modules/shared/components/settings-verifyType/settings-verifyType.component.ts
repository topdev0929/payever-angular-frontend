      ...
      settings: [
        {
          ...
          selectSettings: {
            ...
            options: [
              { value: 0, label: this.translateService.translate('categories.communications.form.verificationType.value.0') },
              { value: 1, label: this.translateService.translate('categories.communications.form.verificationType.value.1') },
            ]
          }
        }
      ]
