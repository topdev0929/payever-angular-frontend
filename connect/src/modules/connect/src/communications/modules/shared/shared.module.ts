...
import {
  CommunicationMainWrapComponent,
  SettingsAutoresponderEnabledComponent,
  SettingsSecondFactorComponent,
  SettingsVerifyTypeComponent,
  SettingsSaveButtonComponent,
} from './components';

export const CommunicationsSharedI18nModuleForChild = I18nModule.forChild();
...
@NgModule({
  ...
  imports: [
    ...
    ClipboardModule,
    MomentModule,
    CommunicationsSharedI18nModuleForChild,
    FormModule,
    FormsModule,
    OverlayBoxModule,
    ReactiveFormsModule,
...
export class CommunicationsSharedModule {}
