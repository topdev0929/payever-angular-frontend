...
import { CanActivate, ActivatedRouteSnapshot, Router, CanDeactivate, ActivatedRoute } from '@angular/router';
...
export class OAuthRedirectGuard implements CanActivate {
  ...
  canActivate(route: ActivatedRouteSnapshot): Observable<boolean> {
    ...
    if (stateParams) {
      ...
      this.router.navigate([`business/${businessUuid}/connect/`], {queryParams: { integration, integrationCategory }});
    }
    return of(false);
  }
