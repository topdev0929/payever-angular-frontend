...
import { Component, OnInit, ChangeDetectionStrategy, ChangeDetectorRef, Injector, TemplateRef, ViewChild, Inject } from '@angular/core';
...
export class IntegrationWriteReviewComponent extends FormAbstractComponent<WriteReviewFormInterface> implements OnInit {
  ...
  protected formStorageKey: string = 'reviewForm';
