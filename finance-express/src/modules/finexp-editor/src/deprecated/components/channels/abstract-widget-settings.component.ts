...
export abstract class AbstractWidgetSettingsComponent extends AbstractComponent {
  ...
  get financeExpressCustomStyleElement(): HTMLStyleElement {
    return window['Payever'] && window['Payever'].FinanceExpress
  ...
  private addWidgetToPage(): void {
    const scriptAlreadyLoaded: boolean = !!window['Payever'];
    ...
    // if (Payever.FinanceExpress['paymentOptionsEnabled']) {
  ...
  subscribeToFormUpdate(): void {
    ...
    this.form.valueChanges.pipe(
      ...
      tap(() => {
        ...
        if (window['Payever'] && window['Payever'].FinanceExpress && window['Payever'].FinanceExpress.embedInstance) {
