...
import { BannerAndRatesWidgetSettingsInterface, WidgetType } from '../../../interfaces';
...
export class CalculatorComponent extends AbstractWidgetSettingsComponent implements OnInit {
  ...
  private setHiddenFields(): void {
    ...
    if (loginData
      && loginData.activeBusiness
      && loginData.activeBusiness.companyAddress
      && loginData.activeBusiness.companyAddress.country
    ) {
