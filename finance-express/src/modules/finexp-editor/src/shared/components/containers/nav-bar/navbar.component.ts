...
import { NavbarColor, NavbarControlPosition, NavbarPosition, NavbarStyle } from '../../../../deprecated/enums';
import { NavbarControl } from '../../../../deprecated/types/navbar-controls.type';
import { NavbarControlInterface } from '../../../../deprecated/interfaces';
...
export class NavbarComponent implements AfterViewInit, OnDestroy {
  ...
  @HostBinding('class.pe-navbar') hostClass: boolean = true;
  ...
  @Input() allowSettingsManualScroll: boolean = true; // When menu item is input and user is trying to select range
  ...
  spinerStrokeWidth: number = 2;
  spinerDiameter: number = 18;
  ...
  private setScrollableToolbarHeight(): void {
    if (this.scrollable && this.toolbar && this.scrollContainer) {
      const scrollbarHeight: number = this.scrollContainer.nativeElement.offsetHeight - this.scrollContainer.nativeElement.clientHeight;
