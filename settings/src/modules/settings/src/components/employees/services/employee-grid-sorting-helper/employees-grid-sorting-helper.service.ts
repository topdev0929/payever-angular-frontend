...
import { EMAIL_ASC, EMAIL_DESC, NAME_ASC, NAME_DESC, POSITION_ASC, POSITION_DESC, STATUS_ASC, STATUS_DESC } from '../../constants';
...
@Injectable()
export class PebEmployeesGridSortHelperService {
