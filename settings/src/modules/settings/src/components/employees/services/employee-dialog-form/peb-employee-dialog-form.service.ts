...
export class PebEmployeeDialogFormService {
  ...
  private getEmployeeFormObject(employee?: BusinessEmployeeInterface): Record<EmployeeFields, [EmployeeValues] | [EmployeeValues, ValidatorFn[]]> {
    ...
    const formObj: Record<EmployeeFields, [EmployeeValues] | [EmployeeValues, ValidatorFn[]]> = {
      ...
      email: [employee?.email || null, [Validators.required, Validators.email]],
