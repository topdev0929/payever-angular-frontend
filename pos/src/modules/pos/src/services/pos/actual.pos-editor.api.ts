...
import { PEB_POS_API_PATH } from '../../constants';
...
export class PebActualEditorApi implements PebEditorApi {
  ...
  getCurrentShopPreview(applicationId: string, currentDetail: boolean, diff: boolean): Observable<any> {
    const endpoint = `${this.editorApiPath}/api/business/${this.envService.businessId}/application/${applicationId}/preview`;
  ...
  installTemplateTheme(themeId: string): Observable<any> {
    return this.http.post(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.posId}/theme/${themeId}/install`, {});
  }

  instantInstallTemplateTheme(themeId: string): Observable<any> {
    return this.http.put(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.posId}/template/${themeId}/instant-setup`, {});
  }

  deleteTemplateTheme(themeId: string): Observable<void> {
    return this.http.delete<void>(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.posId}/theme/${themeId}`, {});
  }

  duplicateTemplateTheme(themeId: string): Observable<any> {
    return this.http.post(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.posId}/theme/${themeId}/duplicate`, {});
  }
  ...
  getShop(): Observable<any> {
    return this.http.get<any[]>(`${this.posApiPath}/business/${this.envService.businessId}/terminal/${this.envService.posId}`);
  }
  ...
  setAsDefaultShop(applicationId: string): Observable<any> {
    return this.http.put<any>(`${this.posApiPath}/business/${this.envService.businessId}/terminal/${applicationId}/default`, {});
  }
  ...
  getShopPreviewPages(applicationId: string, pageId?: string): Observable<any> {
    return this.http.get<any>(`${this.editorApiPath}/api/application/${applicationId}/source/pages/${pageId ? pageId : ''}`);
  }
  ...
  getTemplateShapesByAlbum(albumId: string, { offset = 0, limit = 100 }: PebPaginationParams = {}): Observable<any> {
    return this.http.get<any>(
      `${this.editorApiPath}/api/application/${this.envService.posId}/shape/template/album${albumId ? `/${albumId}` : ''}`,
      { params: { offset: offset.toString(), limit: limit.toString() } },
    );
  }
