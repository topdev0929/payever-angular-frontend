...
import { PEB_POS_API_BUILDER_PATH } from '../../constants';
...
export class ActualBuilderPosApi implements BuilderPosApi {
  ...
  installTemplateTheme(posId: string, templateID: string): Observable<any> {
    const endpoint = `${this.editorApiPath}/api/business/${this.businessId}/application/${posId}/theme/${templateID}/install`;
