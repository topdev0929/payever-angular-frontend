...
describe('ActionShippingGoodsComponent', () => {
  let component: ActionShippingGoodsComponent;
  let fixture: ComponentFixture<ActionShippingGoodsComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ActionShippingGoodsComponent],
      providers: [
        DateFormatPipe,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActionShippingGoodsComponent);
