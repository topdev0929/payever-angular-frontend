...
describe('ActionChangeReferenceComponent', () => {
  let component: ActionChangeReferenceComponent;
  let fixture: ComponentFixture<ActionChangeReferenceComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterModule.forRoot([]), I18nModule.forRoot({}), FormsModule, ReactiveFormsModule],
      declarations: [ActionChangeReferenceComponent],
      providers: [
        DateFormatPipe,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActionChangeReferenceComponent);
