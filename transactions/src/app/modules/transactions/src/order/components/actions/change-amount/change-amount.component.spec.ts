...
describe('ActionChangeAmountComponent', () => {
  let component: ActionChangeAmountComponent;
  let fixture: ComponentFixture<ActionChangeAmountComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterModule.forRoot([]), I18nModule.forRoot({}), FormsModule, ReactiveFormsModule],
      declarations: [ActionChangeAmountComponent],
      providers: [
        DateFormatPipe,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActionChangeAmountComponent);
