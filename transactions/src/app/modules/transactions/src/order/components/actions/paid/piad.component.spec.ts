...
describe('ActionPaidComponent', () => {
  let component: ActionPaidComponent;
  let fixture: ComponentFixture<ActionPaidComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterModule.forRoot([]), I18nModule.forRoot({})],
      declarations: [ActionPaidComponent],
      providers: [
        DateFormatPipe,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActionPaidComponent);
