import { AfterViewInit, Component, ElementRef, EventEmitter, Injector, Input, OnDestroy, OnInit, Output, Renderer2, ViewChild } from '@angular/core';
...
import {
  ...
  ColorPickerFormat, ErrorBag,
  FormAbstractComponent, FormFieldType as FormFieldEnum, FormScheme, FormSchemeField,
