...
import { TextEditorService } from '../../../texteditor/services/text-editor.service';
...
export class CollectionEditorDescriptionComponent extends AbstractComponent implements OnInit, AfterViewInit {
