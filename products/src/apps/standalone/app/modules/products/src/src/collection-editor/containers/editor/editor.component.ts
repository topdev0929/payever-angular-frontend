...
export class CollectionEditorComponent extends AbstractComponent implements OnInit {
  isEdit: boolean;
  ...
  navigateToList() {
    ...
    const url: string[] = ['business', this.envService.businessUuid, 'products', prevPath];
