...
export const trustlyPaymentSteps = (step: Step): void => {
...
const updateElementsVisibility = (step: Step): void => {
  ...
  const showOuterFrame: boolean = step === 5;
  ...
  toggleClass("modal-backdrop", "solid-light-gray", showOuterFrame);
  showElement("pay-modal", false);
