...
describe('ShopThemeGuard', () => {
  ...
  beforeEach(() => {
    ...
    themesApi = jasmine
      .createSpyObj<PebThemesApi>('PebThemesApi', ['createApplicationTheme']) as jasmine.SpyObj<PebThemesApi>;

    envService = {
      shopId: undefined,
    } as jasmine.SpyObj<PebEnvService>;

    guard = new ShopThemeGuard(api, themesApi as any, envService as any);
  ...
  it('should check can activate', () => {
    ...
    expect(api.getShopActiveTheme).toHaveBeenCalledWith();
