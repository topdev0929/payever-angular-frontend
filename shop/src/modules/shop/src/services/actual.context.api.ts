...
export class PebActualContextApi implements PebContextApi {
  ...
  constructor(
    ...
    @Inject(PEB_SHOPS_API_PATH) protected shopApiPath: string,
    @Inject(EnvService) protected envService: ShopEnvService,
  ) {
  }
  ...
  protected getActionParams(
    ...
    const values = {
      ...
      [PebContextActionParams.Shop]: `"${this.envService.shopId}"`,
