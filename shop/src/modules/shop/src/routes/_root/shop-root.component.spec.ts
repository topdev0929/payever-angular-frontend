...
import { PebShopComponent } from './shop-root.component';
import { SidebarAnimationProgress } from './sidebar.animation';

describe('PebShopComponent', () => {

  let fixture: ComponentFixture<PebShopComponent>;
  let component: PebShopComponent;
  let router: any;
  let route: any;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      fixture = TestBed.createComponent(PebShopComponent);
  ...
  //   } as any;
  //
  //   component = new PebShopComponent(
  //     router,
  ...
  it('should init translations on init', () => {
    ...
    expect(component.shop).toEqual({ id: 'shop-001' });
