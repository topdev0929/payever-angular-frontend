...
//
//     expect(api.createApp(null)).toBeUndefined();
//
//   });
//
...
//
//     expect(api.deleteApp(shopId)).toBeUndefined();
//
//   });
//
...
//
//     expect(api.getApp()).toBeUndefined();
//
//   });
//
//   it('should get page', () => {
...
//
//     expect(api.getApps()).toBeUndefined();
//
//   });
//
...
//
//     expect(api.setAsDefaultApp(shopId)).toBeUndefined();
//
//   });
//
...
//
//     expect(api.updateApp({})).toBeUndefined();
//
//   });
//
//   it('should return undefined on update shop deploy', () => {
//
//     expect(api.updateAppDeploy(shopId, {})).toBeUndefined();
//
//   });
//
