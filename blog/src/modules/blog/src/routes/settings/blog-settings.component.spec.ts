...
import { of } from 'rxjs';
import { PebBlogSettingsComponent } from './blog-settings.component';

describe('PebShopSettingsComponent', () => {

  let fixture: ComponentFixture<PebBlogSettingsComponent>;
  let component: PebBlogSettingsComponent;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      fixture = TestBed.createComponent(PebBlogSettingsComponent);
  ...
  it('should be defined', () => {
    ...
    component = new PebBlogSettingsComponent(
      api,
      route,
      overlay,
      messageBus,
