...
describe('PebShopEditorComponent', () => {
  ...
  let fixture: ComponentFixture<PebBlogEditorComponent>;
  let component: PebBlogEditorComponent;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      fixture = TestBed.createComponent(PebBlogEditorComponent);
  ...
  it('should be defined', () => {
    ...
    component = new PebBlogEditorComponent(
      dialog,
      messageBus,
      editorApi,
      route,
