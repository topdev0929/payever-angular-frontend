...
export class MessageBubbleSettingsComponent implements OnInit {
  ...
  bubbleThemeStyleOptions = [
    { value: PeMessageBubbleStyle.Circle, label: this.translateService.translate('message-app.message-integration.circle') },
    { value: PeMessageBubbleStyle.Rounded, label: this.translateService.translate('message-app.message-integration.rounded') },
    { value: PeMessageBubbleStyle.Sharp, label: this.translateService.translate('message-app.message-integration.rectangle') },
  ];
  bubbleThemeStyleLayout = [
    { value: PeMessageBubbleLayouts.Logo, label: this.translateService.translate('message-app.message-integration.logo') },
    { value: PeMessageBubbleLayouts.LogoText, label: this.translateService.translate('message-app.message-integration.logo-name') },
    { value: PeMessageBubbleLayouts.Text, label: this.translateService.translate('message-app.message-integration.name') },
  ];
  bubbleSettingsTitles = [
    { value: PeMessageBubbleBrand.Payever, label: this.translateService.translate('message-app.message-integration.payever-brand') },
    { value: PeMessageBubbleBrand.Custom, label: this.translateService.translate('message-app.message-integration.custom-brand') },
  ];
