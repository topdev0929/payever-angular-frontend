...
@Component({
    selector: 'doc-forms-fieldset-horizontal-example-default',
    templateUrl: 'forms-fieldset-horizontal-example-default.component.html'
})
export class FormsFieldsetHorizontalDefaultComponent {
