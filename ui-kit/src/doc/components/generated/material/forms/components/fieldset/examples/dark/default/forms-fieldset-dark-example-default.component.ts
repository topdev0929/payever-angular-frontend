...
@Component({
    selector: 'doc-forms-fieldset-dark-example-default',
    templateUrl: 'forms-fieldset-dark-example-default.component.html'
})
export class FormsFieldsetDarkDefaultComponent {
