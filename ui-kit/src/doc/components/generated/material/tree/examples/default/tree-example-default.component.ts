...
@Component({
    selector: 'doc-tree-example-default',
    templateUrl: './tree-example-default.component.html',
    styleUrls: ['./tree-example-default.component.scss']
})
export class TreeExampleDefaultComponent {
    tc = TC;
    tc2 = TC2;
    data = [
        {
    ...
    hasChild(nodeIndex: number, node: TestData) {
        console.log(node);
